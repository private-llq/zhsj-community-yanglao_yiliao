...
public class MinioUtil {
     ...
     * @return
     */
    public static String upload(MultipartFile file, String bizPath, String customBucket) throws InvalidResponseException {
        String file_url = "";
        ...
        } catch (IOException | InvalidKeyException | NoSuchAlgorithmException | NoResponseException | XmlPullParserException
                | InvalidArgumentException | RegionConflictException | InvalidBucketNameException | ErrorResponseException
     ...
     * @return
     */
    public static String upload(MultipartFile file, String bizPath) throws InvalidResponseException {
