...
public class RedisUtils {
    ...
    public boolean tryLock(String key, String value, long timeout, TimeUnit timeUnit) {
        ...
        Boolean ifAbsent = redisTemplate.opsForValue().setIfAbsent(redis_lock + key, value, timeout, timeUnit);
    ...
    public Boolean onLock(String key, String value) {
        ...
        return redisTemplate.opsForValue().getOperations().delete(redis_lock + key);
    }
}